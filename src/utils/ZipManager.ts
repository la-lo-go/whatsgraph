import { unzip, type ZipEntry, setOptions } from "unzipit";

setOptions({
	workerURL: "http://localhost:3000/scripts/unzipit-worker.module.js",
});
...
export async function GetFirstTxtFileContent(
	files: ZipEntry[],
): Promise<string | null> {
